...
public static class Loc
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Texts = new()
    {
        [German] = new Dictionary<string, string>
        {
            ...
            ["KrBundleDownloading"] = "Lade das koreanische Dalamud ...",
            ["KrBundleDownloadLabel"] = "Dalamud (koreanisch)",
            ["KrBundleInstalling"] = "Installiere Dalamud ...",
            ["KrBundleInstalled"] = "Dalamud wurde installiert.",
            ["KrBundleHashMismatch"] = "Die geladene Datei ist beschaedigt. Es wurde nichts installiert.",
            ["KrBundleFailed"] = "Dalamud konnte nicht installiert werden: {0}",
            ["KrBundleStillMissing"] = "Die Installation ist unvollstaendig. Es fehlt: {0}",
        ...
        [English] = new Dictionary<string, string>
        {
            ...
            ["KrBundleDownloading"] = "Downloading Korean Dalamud ...",
            ["KrBundleDownloadLabel"] = "Dalamud (Korean)",
            ["KrBundleInstalling"] = "Installing Dalamud ...",
            ["KrBundleInstalled"] = "Dalamud installed.",
            ["KrBundleHashMismatch"] = "The downloaded file is damaged. Nothing was installed.",
            ["KrBundleFailed"] = "Dalamud could not be installed: {0}",
            ["KrBundleStillMissing"] = "The installation is incomplete. Missing: {0}",
        ...
        [Korean] = new Dictionary<string, string>
        {
            ...
            ["KrBundleInstalling"] = "Dalamud를 설치하는 중 ...",
            ["KrBundleInstalled"] = "Dalamud를 설치했습니다.",
            ["KrBundleHashMismatch"] = "내려받은 파일이 손상되었습니다. 설치하지 않았습니다.",
            ["KrBundleFailed"] = "Dalamud를 설치하지 못했습니다: {0}",
            ["KrBundleStillMissing"] = "Dalamud 설치가 끝나지 않았습니다. 없는 것: {0}",
            ["KrBundleGetByHand"] = "아래에서 직접 받을 수 있습니다:",
