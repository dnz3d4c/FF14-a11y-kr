...
public static class Loc
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Texts = new()
    {
        [German] = new Dictionary<string, string>
        {
            ...
            ["KrBundleWhatItIs1"] = "Der KR-Updater kann Dalamud zurzeit nicht holen: das offizielle Dalamud bringt eine neuere FFXIVClientStructs mit, als er kennt.",
            ["KrBundleWhatItIs2"] = "Wir haben eine fertige koreanische Dalamud-Fassung als Zwischenloesung veroeffentlicht.",
            ["KrBundleWhatItIs3"] = "Sobald der KR-Updater nachzieht, wird wieder sein Weg benutzt.",
            ["AskFetchKrBundle"] = "Diese Dalamud-Fassung jetzt holen und einspielen?",
            ["KrBundleSkipped"] = "Die Dalamud-Fassung wurde uebersprungen.",
            ["KrBundleDownloading"] = "Lade die koreanische Dalamud-Fassung ...",
            ["KrBundleDownloadLabel"] = "Dalamud (koreanisch)",
            ["KrBundleExtracting"] = "Entpacke nach {0} ...",
            ["KrBundleInstalled"] = "Dalamud wurde eingespielt.",
            ["KrBundleHashMismatch"] = "Die geladene Datei stimmt nicht (erwartet {0}, bekommen {1}). Nichts wurde entpackt.",
            ["KrBundleFailed"] = "Die Dalamud-Fassung konnte nicht eingespielt werden: {0}",
            ["KrBundleStillMissing"] = "Nach dem Entpacken fehlt weiterhin: {0}",
            ["KrBundleGetByHand"] = "Die Datei kann auch von Hand hier geholt werden:",
        ...
        [English] = new Dictionary<string, string>
        {
            ...
            ["KrBundleWhatItIs1"] = "The KR updater cannot fetch Dalamud right now: official Dalamud ships a newer FFXIVClientStructs than it knows.",
            ["KrBundleWhatItIs2"] = "We published a ready-made Korean Dalamud copy as a stopgap.",
            ["KrBundleWhatItIs3"] = "Once the KR updater catches up, its own way is used again.",
            ["AskFetchKrBundle"] = "Fetch and install that Dalamud copy now?",
            ["KrBundleSkipped"] = "The Dalamud copy was skipped.",
            ["KrBundleDownloading"] = "Downloading the Korean Dalamud copy ...",
            ["KrBundleDownloadLabel"] = "Dalamud (Korean)",
            ["KrBundleExtracting"] = "Extracting to {0} ...",
            ["KrBundleInstalled"] = "Dalamud is in place.",
            ["KrBundleHashMismatch"] = "The downloaded file does not match (expected {0}, got {1}). Nothing was extracted.",
            ["KrBundleFailed"] = "The Dalamud copy could not be installed: {0}",
            ["KrBundleStillMissing"] = "Still missing after extracting: {0}",
            ["KrBundleGetByHand"] = "The file can also be fetched by hand here:",
        ...
        [Korean] = new Dictionary<string, string>
        {
            ...
            ["KrBundleWhatItIs1"] = "지금은 KR Dalamud 업데이터가 Dalamud를 받아 오지 못합니다. 공식 Dalamud가 업데이터보다 새로운 FFXIVClientStructs를 싣고 있기 때문입니다.",
            ["KrBundleWhatItIs2"] = "한국 서버용으로 만들어 둔 Dalamud를 임시로 배포하고 있습니다.",
            ["KrBundleWhatItIs3"] = "업데이터가 새 버전을 내면 그때부터는 다시 업데이터가 받아 옵니다.",
            ["AskFetchKrBundle"] = "이 Dalamud를 지금 받아서 넣으시겠습니까?",
            ["KrBundleSkipped"] = "Dalamud 받기를 건너뛰었습니다.",
            ["KrBundleDownloading"] = "한국 서버용 Dalamud를 내려받는 중 ...",
            ["KrBundleDownloadLabel"] = "한국 서버용 Dalamud",
            ["KrBundleExtracting"] = "{0}에 압축을 푸는 중 ...",
            ["KrBundleInstalled"] = "Dalamud를 넣었습니다.",
            ["KrBundleHashMismatch"] = "내려받은 파일이 원본과 다릅니다. 예상한 값은 {0}이고 받은 값은 {1}입니다. 압축은 풀지 않았습니다.",
            ["KrBundleFailed"] = "Dalamud를 넣지 못했습니다: {0}",
            ["KrBundleStillMissing"] = "압축을 풀었는데도 없는 것이 있습니다: {0}",
            ["KrBundleGetByHand"] = "이 파일은 아래에서 직접 받을 수도 있습니다:",
