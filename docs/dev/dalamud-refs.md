...
**같은 판끼리일 때만 성립한다.** 2026-09-09에 공식 `latest.zip`이 15.0.3.3으로 오른 뒤 다시 재니 **넷이 다 달라졌다** — 설치본은 아직 15.0.3.2였기 때문이다. 위 경고가 말하는 일이 실제로 일어난 것이고, 대조는 반드시 **같은 어셈블리 판끼리** 해야 한다. 판이 어긋난 채로 재면 "달라졌으니 표를 고쳐야 한다"는 잘못된 결론에 이른다.
